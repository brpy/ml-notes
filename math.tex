...
\begin{itemize}
	...
	\item Uncorrected: (using same formula as population)
	\begin{equation}
...
\begin{itemize}
	 ...
	 \begin{figure}[ht!]
		...
		\graphicspath{ {images/math/} }
		\includegraphics[height=160pt]{visualisation_mode_median_mean}
	\end{figure}
...
\formdesc{Skewness and Kurtosis}:
\begin{itemize}
