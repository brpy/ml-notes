...
\begin{itemize}
	\item For many distributions, the sampling distribution of the sample mean tends to follow a \textbf{Normal distribution}.
...
\begin{itemize}
	...
	\item Each Bernouli trial $\implies$ Yes or no outcomes; Coin toss.
	\item pmf \begin{math}
